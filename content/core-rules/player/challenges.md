...
The players will usually know the threat level of the challenge they’re facing. However, depending on the nature and tone of the story, it might be fun for the GM to keep the threat level secret until some sort of milestone has been reached within the scene.

## Mechanics of Play
As a group, each player describes how their character is approaching the challenge. As long as the characters are freely able to communicate within the constraints imposed by the GM, players may freely pass the narrative to each other and the GM as they describe their approach to the scene. Depending on the nature of the setting and the challenge, a quantum-entangled communicator, text message, telepathy, or carrier pigeons might all be viable methods of communication.

The GM will provide the non-player character side of any dialogue, descriptions of changes in the environment due to character actions, and so forth.

In Heroic Tales the narrative proceeds in a free-form fashion. Individual actions may take as long as needed to serve the story and the collective approach.

Once the group is done with their description, each player rolls a pool of six-sided dice equal to half the team’s *power level*, rounding up, plus one die for each *skill*, *power*, or *interest* they tie into the description, to a maximum of three additional dice.

After the dice are rolled, the player tallies the results. A four, five, or six counts as a success; a three is neutral; and a one or two counts as a failure, each of which cancels out a success.
