...
What can you describe to the players so that the characters have a sense of place and purpose? What does the location of the challenge look like? Sound like? Smell like? Are the characters physically present with each other or are they communicating in some other fashion?

Are there people present? What are their names and personalities? Are there creatures? Monsters? Self-aware, super-intelligent math formulae?
...
Therefore, a hard challenge should have at least two milestones and a normal challenge one milestone. For an easy challenge, the milestone is optional.

For example, perhaps the second wave of zombie ninja arrives, and this wave is armed with electrified tonfa. Perhaps the characters lop the skyscraper-sized tentacles off the great old one and now they have to prevent the twitching limbs from destroying the city while also closing the gate to the Far Realm.

## Complications

It can also be helpful to have a few _complications_ handy for when a player costs the team momentum. A good complication illustrates that the situation just got worse, but still allows the characters the freedom to continue working as a team.

For example, Kristivn “Kris” Kristvinson, the dwarven barbarian, rolls a complication while his team is battling skeletons near the entrance of the Höhle der Winde. Before the team entered the colossal cave system, they learned that it is filled with traps, so you decide that Kris has blundered into a ten-foot-deep pit. Now Kris’ player has to narrate climbing out of the trap (or having his teammates help him) before he can get back to swinging his battle axe.

Mechanically, the team has taken a penalty for the bad roll by losing momentum. The complication is a narrative device that works in tandem with momentum to reflect the setback in the story.

## Success and Failure

The players will eventually reduce the _inertia_ of the challenge to zero or they will lose all of their _momentum_. What happens in either scenario?
...
Failure, on the other hand, can mean many things but it should always propel the narrative forward; failure should never mean that the story comes to a halt and the party gets stuck. Perhaps the group realizes that the great dragon has the upper hand as it physically picks them up and tosses them out of its lair. Perhaps the spelunkers wander, lost in the crevasses of Höhle der Winde, and make it to their checkpoint three days late, missing a key contact by a few hours. Now they have to implement Plan B and formulate an alternate plan to infiltrate the Koboldkönig’s lair.

## Inertia

The inertia of a challenge can range from one to fifty. The appropriate value for a particular challenge depends on the team’s _power level_, the number of characters participating in the challenge, and how hard or easy you want the challenge to be.

Consult the tables below to determine the appropriate inertia for your challenge. These numbers are based on the standard size of a player’s dice pool at any given power level. If a character has advantage, or a player incorporates their _traits_ into their actions, then the challenge will be easier. However, if a character is suffering from disadvantage, then the challenge will be harder.

You can vary the inertia of individual challenges in order to create variety, as long as you use the provided tables as a guide.

### One Player

| Power Level | Easy | Normal | Hard |
| ----------- | ---- | ------ | ---- |
| 1-2         | 0    | 2      | 2    |
| 3-4         | 2    | 2      | 4    |
| 5-6         | 2    | 2      | 4    |
