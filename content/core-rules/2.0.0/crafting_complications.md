...
- **Complications** — when the team suffers a setback, what does it look like?
...
As the scene unfolds, how does it change? What happens? An engaging challenge should be dynamic and react to the actions of the characters. Attempt to have the scene meaningfully change every three rounds or so. This prevents the action from becoming stale, and it prevents the players from running out of interesting things to do.

A hard challenge should have at least two milestones and a normal challenge one milestone. For an easy challenge, the milestone is optional.
...
It can also be helpful to have a few ideas handy for when a player costs the team momentum. A good complication illustrates that the situation just got worse, but still allows the characters the freedom to continue working as a team.
