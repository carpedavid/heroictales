...
- Removed abilities and interests, coalescing “traits” into three ability scores.
- Added personality tools.
- Modified benefits from advancing in level.
- Added resources rules.
- Added bounded accuracy, changing the way inertia is determined.

### 1.X.X

- 1.1.0 -- added a default advancement system and clarified language for calculating the results of a team’s dice roll.
- 1.0.2 -- _very_ minor formatting changes to clean the document up and reduce file size.
